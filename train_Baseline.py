# 2021/4/16 Baseline学習用
# 実験環境trainプログラム
# seedを指定して学習する！

# ------実行コマンド！！！！-------
# python train_Baseline.py --savedir=[保存するモデルの名前（dirになる（joint_rangeなどを書く！！）] --seed=(int)
# ------------------------------
...
class ChangeJointRangeEnv(gym.Wrapper):
    ...
    def reset_task(self,value=None):
        ...
        # cripple leg 0~2 (in training env), cripple leg 3 (in validation env)
