...
python eval_for_bar.py --agent=Baseline_Ant-v2 --n_episodes=50
python eval_for_bar.py --agent=Baseline_Ant-v2_k08 --n_episodes=50
python eval_for_bar.py --agent=Baseline_Ant-v2_k06 --n_episodes=50
python eval_for_bar.py --agent=Baseline_Ant-v2_k04 --n_episodes=50
python eval_for_bar.py --agent=Baseline_Ant-v2_k02 --n_episodes=50
python eval_for_bar.py --agent=Baseline_Ant-v2_k00 --n_episodes=50